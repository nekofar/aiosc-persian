...
add_action( 'plugins_loaded', function () {
	...
	load_plugin_textdomain( 'aiosc', false, dirname( plugin_basename( __FILE__ ) ) . '/languages' );
} );

// add css file to the admin header
add_action( 'admin_enqueue_scripts', function () {
	wp_register_style( 'aiosc-persian', plugins_url( '/assets/css/styles.css', __FILE__ ) );
	wp_enqueue_style( 'aiosc-persian' );
} );